  ...
  return (
    <div className="flex flex-col items-center">
      ...
      >
        ...
        <h3 className="text-2xl sm:text-3xl font-bold text-center text-pink-600 mt-2">To Mansi Ji 💪</h3>
      </motion.div>
          ...
          <AnimatePresence>
            ...
            >
              <div className="text-center">
                <p className="text-purple-700 mb-2 mt-8">
I hope your day is filled with everything that makes you smile. I’m really glad to have you as a friend—your positivity makes life brighter. Wishing you a year full of happiness, new adventures, and everything you deserve. 🎉💛                </p>
      ...
      >
        <div className="text-center">
          ...
          May every wish you make today come true. You deserve the world, We're always be here to remind you of that.
          </p>
          <div className="flex justify-center items-center gap-2">
            <p className="text-pink-600 font-medium">Let’s always stay like this... forever, stronger, happier, healthier also wealthier 🫶</p>
          </div>
        </div>
      </motion.div>
    </div>
